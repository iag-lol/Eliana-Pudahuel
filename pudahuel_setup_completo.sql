...
DROP POLICY IF EXISTS "Permitir lectura autenticada de productos" ON pudahuel_products;
DROP POLICY IF EXISTS "Permitir inserción autenticada de productos" ON pudahuel_products;
DROP POLICY IF EXISTS "Permitir actualización autenticada de productos" ON pudahuel_products;
DROP POLICY IF EXISTS "Permitir eliminación autenticada de productos" ON pudahuel_products;
...
DROP POLICY IF EXISTS "Permitir lectura autenticada de clientes" ON pudahuel_clients;
DROP POLICY IF EXISTS "Permitir inserción autenticada de clientes" ON pudahuel_clients;
DROP POLICY IF EXISTS "Permitir actualización autenticada de clientes" ON pudahuel_clients;
DROP POLICY IF EXISTS "Permitir eliminación autenticada de clientes" ON pudahuel_clients;
...
DROP POLICY IF EXISTS "Permitir lectura autenticada de turnos" ON pudahuel_shifts;
DROP POLICY IF EXISTS "Permitir inserción autenticada de turnos" ON pudahuel_shifts;
DROP POLICY IF EXISTS "Permitir actualización autenticada de turnos" ON pudahuel_shifts;
DROP POLICY IF EXISTS "Permitir eliminación autenticada de turnos" ON pudahuel_shifts;
...
DROP POLICY IF EXISTS "Permitir lectura autenticada de ventas" ON pudahuel_sales;
DROP POLICY IF EXISTS "Permitir inserción autenticada de ventas" ON pudahuel_sales;
DROP POLICY IF EXISTS "Permitir actualización autenticada de ventas" ON pudahuel_sales;
DROP POLICY IF EXISTS "Permitir eliminación autenticada de ventas" ON pudahuel_sales;
...
DROP POLICY IF EXISTS "Permitir lectura autenticada de movimientos" ON pudahuel_client_movements;
DROP POLICY IF EXISTS "Permitir inserción autenticada de movimientos" ON pudahuel_client_movements;
DROP POLICY IF EXISTS "Permitir actualización autenticada de movimientos" ON pudahuel_client_movements;
DROP POLICY IF EXISTS "Permitir eliminación autenticada de movimientos" ON pudahuel_client_movements;
...
DROP POLICY IF EXISTS "Permitir lectura autenticada de gastos" ON pudahuel_shift_expenses;
DROP POLICY IF EXISTS "Permitir inserción autenticada de gastos" ON pudahuel_shift_expenses;
DROP POLICY IF EXISTS "Permitir actualización autenticada de gastos" ON pudahuel_shift_expenses;
DROP POLICY IF EXISTS "Permitir eliminación autenticada de gastos" ON pudahuel_shift_expenses;
